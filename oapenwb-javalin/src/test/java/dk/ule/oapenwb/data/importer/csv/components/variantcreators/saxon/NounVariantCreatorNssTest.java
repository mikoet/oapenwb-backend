...
public class NounVariantCreatorNssTest
{
	...
	void testSingleFormDefinitions()
	{
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"dingsdag", ""}));
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"byspil n", ""}));
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"hauptanklaagde (f, m)", ""}));
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"geagendeyl ~ teagendeyl", ""}));
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"geagendeyl ~ teagendeyl n", ""}));
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"geagendeyl ~ teagendeyl ( f,  m,n)", ""}));
	...
	void testMultiFormDefinitions()
	{
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"deepde, deepden", ""}));
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"deert, deerten ~ deerter", ""}));
...

		{
			...
			List<Variant> result = creator.create(null /* no context for now */,
				new RowData(1, new String[] {"minsk ~ minske, minsken (m, n)", ""}));
